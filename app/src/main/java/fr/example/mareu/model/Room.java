...
public enum Room{
    ...
    MARIO (R.string.Peach,R.drawable.ic_room_mario,R.color.red),
    ...
    DAISY(R.string.Daidy,R.drawable.ic_room_daisy,R.color.orange),
    ...
    Room(@StringRes int nameRes, @DrawableRes int iconRes, @ColorRes int colorRes){
